<?php
	...
	$mcImageManagerConfig['general.error_log'] = "debug";
	...
	// Preview options
	$mcImageManagerConfig['preview.wwwroot'] = '/var/www/html/clubedevantagensrenner.com.br/httpdocs/'; // absolute or relative from this script path, try to leave blank system figures it out.
	$mcImageManagerConfig['preview.urlprefix'] = "http://www.clubedevantagensrenner.com.br/"; // domain name
	...
	$mcImageManagerConfig['filesystem.path'] = 'public/uploads/images/'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../public/uploads/images/'; // absolute or relative from this script path, required.
